	...
	return (
		<div className='w-full flex flex-row flex-wrap justify-center'>
			...
			<div className='container mt-5'>
				...
				<p className='leading-loose m-2 md:m-10 font-body text-sm md:text-lg'>
				...
				<p className='leading-loose m-2 md:m-10 font-body text-sm md:text-lg'>
					When spring and summer rolls around, you can find me in search of the
					elusive little white ball. Golf season in Canada is short, so when the
					weather permits, I’m out on the fairway, or in the bushes, or fishing
					a ball out of a creek, or trying to chip out of the sand. Aww, the
					great outdoors, don’t you just love it? I also enjoy playing
					pickleball. I gave up curling in 2016 and started playing pickleball
					because it gave me a better cardio workout and I could play
					...
					you’re taking them to see a real dragon!{' '}
				</p>

				<p className='leading-loose m-2 md:m-10 font-body text-sm md:text-lg'>
					I have a private pilot licence and have logged hours in a Cessna 150
					and 152. My love of flying came from my dad. He used to take me flying
					with him in his plane when I was but a wee lass. I enjoyed the sense
					of freedom that came with flying in a small airplane. As they say, the
					sky’s the limit! I also enjoy photography, especially photographs of
					nature.
				</p>
			</div>
		</div>
