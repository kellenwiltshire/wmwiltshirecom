			...
			<div className='flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-4 2xl:row-span-2 2xl:pb-8 ml-2 pt-4 px-6'>
				...
				<div className='bg-indigo-600 lg:order-1 lg:row-span-1 2xl:row-span-1 lg:col-span-2 rounded-lg shadow-xl mb-5 lg:mb-0'>
					<div className='mx-6 my-8 2xl:mx-10'>
						<h1 className='text-white text-xs md:text-base 2xl:text-2xl'>
							Shelby W
						</h1>
					</div>
				...
				<div className='bg-primary-color-white lg:order-3 lg:row-span-2 2xl:row-span-3 lg:col-span-1 rounded-lg shadow-xl mb-5 lg:mb-0 2xl:mb-8'>
					<div className='mx-8 my-10 lg:my-8'>
						<h1 className='primary-color-blackish-blue text-xs md:text-base 2xl:text-2xl'>
							Carol H
						</h1>
					</div>
				...
				<div className='bg-purple-800 lg:order-4 lg:row-span-2 2xl:row-span-1 col-span-3 rounded-lg shadow-xl mb-5 lg:mb-0 2xl:mb-8 lg:pb-14 2xl:pb-20'>
